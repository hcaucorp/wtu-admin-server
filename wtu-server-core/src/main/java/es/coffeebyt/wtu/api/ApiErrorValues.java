...
public class ApiErrorValues {
    ...
    public final static String maltaGiftCodeFailingWithOnePerCustomerError =
    ...
    public static void handleGiftCardRedemption(RedemptionRequest redemptionRequest) {
        if (MALTA_VOUCHER_REDEMPTION_ERROR_ONE_PER_CUSTOMER.equals(redemptionRequest.getVoucherCode())) {
