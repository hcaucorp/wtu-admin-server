...
import cash.bitcoinj.wallet.DefaultRiskAnalysis;
import cash.bitcoinj.wallet.KeyBag;
import cash.bitcoinj.wallet.RedeemData;
    ...
    public String toString() {
        ...
        try {
            if (isCoinBase()) {
                ...
                String flags = Joiner.on(", ").skipNulls().join(hasSequence() ? "sequence: " + Long.toHexString(sequence) : null, null);
                if (!flags.isEmpty())
