...
import cash.bitcoinj.core.listeners.PeerDiscoveredEventListener;
...
import cash.bitcoinj.net.discovery.MultiplexingDiscovery;
import cash.bitcoinj.net.discovery.PeerDiscovery;
import cash.bitcoinj.net.discovery.PeerDiscoveryException;
import cash.bitcoinj.net.discovery.TorDiscovery;
